...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "nFlow by Nevorai — See who's watching" },
      { name: "description", content: "Share your business video. Your prospect can't skip it — and you'll know exactly when they watched it. nFlow by Nevorai." },
      { name: "author", content: "Nevorai" },
      { name: "keywords", content: "nFlow, Nevorai, business video, unskippable video, video sharing, video tracking, see who watched" },
      ...
      { property: "og:site_name", content: "nFlow by Nevorai" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://nflow.nevorai.com" },
