...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Share business videos that get watched. Know exactly who watched, when, and how much." },
      ...
      { name: "twitter:description", content: "Share business videos that get watched." },
