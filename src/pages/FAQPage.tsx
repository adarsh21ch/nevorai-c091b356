...
const faqs = [
  ...
  { q: "Who is nFlow for?", a: "nFlow is built for digital entrepreneurs, creators, coaches, educators, and anyone who uses video to grow their audience and business." },
  ...
  { q: "Do I need technical skills to use it?", a: "Not at all. nFlow is designed for non-technical users. Upload, configure, share — it's that simple." },
