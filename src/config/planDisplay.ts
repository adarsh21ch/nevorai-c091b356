export type PlanKeyLike = "free" | "basic" | "starter" | "growth" | "pro" | "leader" | "trial" | "expired" | string | null | undefined;
...
export const PLAN_DISPLAY: Record<string, PlanDisplay> = {
  ...
  leader: { name: "Leader", color: "#F59E0B", gradient: "from-amber-500 to-orange-600", badgeClass: "bg-amber-500/15 text-amber-300 border border-amber-400/30" },
  ...
  trial: { name: "Free Trial", color: "#00C896", gradient: "from-emerald-500 to-blue-600", badgeClass: "bg-emerald-500/12 text-emerald-300 border border-emerald-400/25" },
